        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CompensationAdjustments_Employees_EmployeeEmpId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployeeEmpId = table.Column<int>(type: "int", nullable: true),
                    PayrollId1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PayrollDetails_Employees_EmployeeEmpId",
                        column: x => x.EmployeeEmpId,
                        principalTable: "Employees",
                        principalColumn: "EmpId");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PayrollDetails_Payrolls_PayrollId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompensationAdjustments_EmployeeEmpId",
                table: "CompensationAdjustments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PayrollDetails_EmployeeEmpId",
                table: "PayrollDetails",
                column: "EmployeeEmpId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PayrollDetails_PayrollId1",
                table: "PayrollDetails",
                column: "PayrollId1");
        }
